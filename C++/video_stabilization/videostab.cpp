...
void VideoStab::Kalman_Filter(double* scaleX, double* scaleY, double* thetha, double* transX, double* transY)
{
    ...
    double frame_1_errthetha = errtheta + Q_theta;
    ...
    double gain_thetha = frame_1_errthetha / (frame_1_errthetha + R_theta);
    ...
    *thetha = frame_1_thetha + gain_thetha * (sum_theta - frame_1_thetha);
    ...
    *transY = frame_1_transY + gain_transY * (sum_transY - frame_1_transY);
    ...
    errtheta = (1 - gain_thetha) * frame_1_errthetha;
